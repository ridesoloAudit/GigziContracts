...
contract GigBlack is BurnableToken, FeeableToken {
    ...
    function processTransfer(address _from, address _to, uint256 _value) internal returns (bool) {
        ...
        // TODO: Refactor this code so isFeeShouldBePaid should not be executed twice
        // TODO: Test what if tx is from FeeCollector
        if (FeeableToken.isFeeShouldBePaid(_from, _to))
            updateAccountReward      (txFeeCollector);

        FeeableToken.processTransfer (_from, _to, _value);
    }
    
    // ***********************************************************************************
    // Override burn method to add update of account reward
    // ***********************************************************************************
